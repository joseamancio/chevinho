    ...
    <div class="container">
            ...
            <div class="col-sm-6 col-12 clearfix">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p><b>Conta Corrente:</b> 23921-6</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-12 clearfix">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p><b>Operação:</b> 013</p>
                        <p><b>Conta Poupança:</b> 23338-2</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-6 col-12 clearfix">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p><b>Conta Corrente:</b> 16309-4</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-12 clearfix">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p><b>Conta Corrente:</b> 2176641-0</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row row-dados-bancarios">
            <div class="col-sm-6 col-12 clearfix">
                <div class="row">
                    <div class="col-sm-4 col-4">
                        <img src="{{asset('img/picpay.png')}}" class="img-responsive" alt="Banco do Brasil">
                    </div>
                    <div class="col-sm-8">
                        <p><b>Conta:</b>@renatodragunskis</p>
                    </div>
                </div>
            </div>
        </div>
